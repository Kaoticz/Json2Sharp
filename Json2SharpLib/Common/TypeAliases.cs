...
internal static class TypeAliases
{
    ...
    /// <summary>
    /// Maps C# CLR types to their corresponding Kotlin aliases.
    /// </summary>
    public static FrozenDictionary<Type, string> KotlinAliasTypes { get; } = new Dictionary<Type, string>()
    {
        [typeof(string)] = "String",
        [typeof(int)] = "Int",
        [typeof(byte)] = "Byte",
